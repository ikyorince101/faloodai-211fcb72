  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        cosmic: "0 8px 32px -4px hsl(var(--primary) / 0.15), 0 4px 16px -2px hsl(var(--background) / 0.8)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
        ...
        "pulse-glow": {
          ...
          "50%": {
            boxShadow: "0 0 30px hsl(var(--accent) / 0.6), 0 0 60px hsl(var(--accent) / 0.3)",
          },
        },
        shimmer: {
      ...
      animation: {
        ...
        "progress-rune": "progress-rune 0.6s ease-out",
        twinkle: "twinkle 3s ease-in-out infinite",
      },
      backgroundImage: {
        "gradient-radial": "radial-gradient(var(--tw-gradient-stops))",
        "gradient-cosmic": "linear-gradient(135deg, hsl(var(--primary) / 0.15) 0%, hsl(var(--accent) / 0.1) 100%)",
        "gradient-aurora": "linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--accent)) 100%)",
